    ...
    for caja in cajas:
        ...
        if id != -1:
            ...
            if numero_placa is not None:
                cuadro_numero_placa = cv2.putText(cuadro, aver, (int(x1), int(y1)), cv2.FONT_HERSHEY_SIMPLEX, 6, (128, 17, 0), 7, cv2.LINE_AA)
                numero_placa_prev = aver
